...
public class SignupActivity extends AppCompatActivity {
    ...
    EditText _mobileText = findViewById(R.id.input_mobile);
    EditText _passwordText = findViewById(R.id.input_password);
    EditText _reEnterPasswordText = findViewById(R.id.input_reEnterPassword);
    ...
    _loginLink.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            //Finish registration and return to login screen
