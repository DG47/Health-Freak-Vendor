...
public class LoginActivity extends AppCompatActivity {
    ...
    //Add database entry for Login
    EditText _emailText = (EditText) findViewById(R.id.input_email);
    EditText _usernameText = (EditText) findViewById(R.id.input_username);
    ...
    public void login() {
        ...
        //TODO: add database and implement own login logic here.

        new android.os.Handler().postDelayed(
                new Runnable() {
                    public void run() {
                        //On complete can call either onLoginSuccess or onLoginFailed
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        if(requestCode == REQUEST_SIGNUP){
            if(resultCode == RESULT_OK){
                ...
                //By default automatic login is done;
                this.finish();
            }
        }
    }
